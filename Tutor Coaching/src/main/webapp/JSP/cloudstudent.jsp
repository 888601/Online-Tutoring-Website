...
<link rel="icon" type="image/x-icon" href="/Tutor_Coaching/Images/favicon.ico">
    ...
    <link rel="stylesheet" href= "/Tutor_Coaching/styles/NewFile.css">
    <style>
  ul {
  ...
  ul li {
    position: relative;
    padding-left: 30px; /* Adjust spacing between tick mark and text */
  }
  ul li:before {
    content: "\2713"; /* Unicode for check mark character */
    color: red; /* Color of the tick mark */
    font-size: 1.2em; /* Adjust tick mark size */
    position: absolute;
    left: 0;
    top: 50%;
...
<body>
    <header class="bg-dark text-light py-3">
        <div class="container d-flex justify-content-between align-items-center">
            <h1 class="m-0">Cloud Computing</h1>
            <div>
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu" aria-labelledby="courseDropdown">
                        ...
                        <a class="dropdown-item" href="javaeestudent.jsp">Java EE</a>
    ...
    <main class="p-4">
        <div class="container">
            <img src="/Tutor_Coaching/Images/b.png" alt="Full Stack JavaScript" class="course-image">
...
<div class="row">
    <div class="col-md-6">
        <div class="section-container">
            ...
            <a href="/Tutor_Coaching/Details/cloud.pdf" class="download-link">Download Course Outline PDF</a>
        </div>
    </div>
    <div class="col-md-6">
        <div class="section-container">
            <h3>Teaching Plan</h3>
            <a href="/Tutor_Coaching/Details/cloud.xlsx" class="download-link">Download Teaching Plan PDF</a>
        </div>
    </div>
</div>
            ...
            <!-- Weeks Sections -->
          <%-- Define the course name (default to "CloudComputing" if not specified) --%>
    <% String courseName = request.getParameter("courseName"); %>
    <% if (courseName == null || courseName.isEmpty()) {
           courseName = "CloudComputing"; // Default course name
       }
    %>
