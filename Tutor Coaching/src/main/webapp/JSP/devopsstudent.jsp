...
<body>
 ...
 <header class="bg-dark text-light py-3">
            ...
            <div>
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu" aria-labelledby="courseDropdown">
                        ...
                        <a class="dropdown-item" href="javaeestudent.jsp">Full Stack Java EE</a>
                ...
                <div class="dropdown d-inline-block">
                    ...
                    &nbsp;  &nbsp;   Hi <%= session.getAttribute("firstName") %>
                        ...
                        <a class="dropdown-item" href="/Tutor_CAoaching/HTML/calendar.html">Calendar</a>
    ...
    <main class="p-4">
        <div class="container">
            <img src="/Tutor_Coaching/Images/devops.jpg" alt="Full Stack JavaScript" class="course-image">
...
<div class="row">
    <div class="col-md-6">
        <div class="section-container">
            ...
            <a href="/Tutor_Coaching/Details/devops.pdf" class="download-link">Download Course Outline PDF</a>
        </div>
    </div>
    <div class="col-md-6">
        <div class="section-container">
            <h3>Teaching Plan</h3>
            <a href="/Tutor_Coaching/Details/devops.xlsx" class="download-link">Download Teaching Plan PDF</a>
        </div>
    </div>
</div>
    ...
    <% if (courseName == null || courseName.isEmpty()) {
           courseName = "DEVOPS"; // Default course name
       }
    %>
